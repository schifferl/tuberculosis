...
To contribute to the `r BiocStyle::Biocpkg("tuberculosis")` R/Bioconductor package, first read the contributing guide and then open an issue. Also note that in contributing you agree to abide by the code of conduct.
